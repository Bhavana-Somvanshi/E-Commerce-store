...
export default function Testimonials() {
  ...
  const testimonials = usePublicApi<Testimonial[]>('/reviews', []);
    ...
    <section id="testimonials" className="section-padding bg-white overflow-hidden" ref={sectionRef}>
      <div className="container-custom">
        ...
        {testimonials.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-gray-200 bg-[#f9f9f9] px-6 py-16 text-center text-gray-500">
                ...
                return (
                  ...
                  >
                    <div className="bg-[#f9f9f9] rounded-2xl p-8 md:p-10 h-full flex flex-col items-center text-center">
                      ...
                      <p className="text-lg text-[#555] leading-relaxed mb-6 max-w-2xl">"{testimonial.text}"</p>
                ...
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                      index === activeIndex ? 'bg-[#ff4b2f] w-8' : 'bg-gray-300 hover:bg-gray-400'
                    }`}
