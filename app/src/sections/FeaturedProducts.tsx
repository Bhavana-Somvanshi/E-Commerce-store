...
export default function FeaturedProducts() {
  ...
  const apiProducts = usePublicApi<Partial<Product>[]>('/products', []);
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-[#555] leading-relaxed">
            Discover the products currently available in your catalog.
          </p>
        </div>
        ...
        {featuredProducts.length === 0 ? (
          ...
          <div className="relative px-12 md:px-16">
            ...
            >
              ...
              <CarouselPrevious className="left-0 border-gray-200 bg-white text-black shadow-sm hover:bg-[#ff4b2f] hover:text-white" />
              <CarouselNext className="right-0 border-gray-200 bg-white text-black shadow-sm hover:bg-[#ff4b2f] hover:text-white" />
            </Carousel>
          </div>
        )}
